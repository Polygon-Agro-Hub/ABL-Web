const ApproachCards = () => {
    const approaches = [
        ...
        },
        {
            text: (
                <>
                    <strong>Financial Inclusion</strong> is central to our strategy. Beyond
                    providing access to affordable credit and crop insurance, ABL mentors
                    farmers on financial planning, investment, and risk management. This
                    ensures that every farmer can scale their operations with confidence
                    and sustainability.
                </>
            ),
        },
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8 justify-items-center">
                    {approaches.map((item, index) => (
                        <div
                            key={index}
                            className={`border border-[#B0B0B0] rounded-2xl p-8 text-left w-full flex items-center ${index === approaches.length - 1
                ...
                <p className="text-lg mt-16 text-[#353535] text-center">
                    Through this integrated approach, ABL empowers farmers to thrive, communities to prosper, and Sri Lanka’s agriculture to<br />
                    reach new heights. We are building more than a farming network – we are creating a movement for transformation, <br />
