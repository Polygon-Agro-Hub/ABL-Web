    ...
    return (
        ...
        >
            <div className="container mx-auto px-4 sm:px-8">
                    ...
                    <nav className="hidden lg:flex items-center space-x-8">
                        {navigation.map((item) => (
                            ...
                            >
                                ...
                                <span
                                    className={`absolute -bottom-1 left-0 h-1 bg-(--color-primary) transition-all ${isActive(item.href)
                                        ? 'w-full'
                ...
                {/* Mobile Navigation */}
                <div
                    className={`lg:hidden transition-all duration-300 overflow-hidden bg-white ${isMobileMenuOpen
                    ...
                    <nav className="flex flex-col space-y-3">
                        {navigation.map((item) => (
                            <Link
                                key={item.name}
                                href={item.href}
                                className={`font-medium transition-colors py-2 px-4 rounded-lg ${isActive(item.href)
